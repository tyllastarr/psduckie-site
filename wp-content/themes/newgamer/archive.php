...
<div id="content">
					...
					<div class="archivetek"><?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'newgamer' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'newgamer' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'newgamer' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'newgamer' ), get_the_date( _x( 'Y', 'yearly archives date format', 'newgamer' ) ) );

						else :
							_e( 'Archives', 'newgamer' );
