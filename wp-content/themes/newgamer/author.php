...
<div class="archivetek"><?php printf( __( 'Showing all posts by %s', 'newgamer' ), get_the_author() ); ?></div>
...
<div class="post-date"><?php _e('Posted on ', 'newgamer'); ?><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_time(get_option('date_format')) ?></a></div>
